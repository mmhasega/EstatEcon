...
Por definição, o \textbf{índice de Gini (G)} é uma relação entre a área de desigualdade, indicada por \(a\) que aqui passaremos a denominar de \(\alpha\), e a área do triângulo ABC que é numericamente igual a 0,5, ou seja,
...
A fórmula \eqref{eq:Gini} é uma das fórmulas de Gini que tem utilidade do ponto de vista teórico.
