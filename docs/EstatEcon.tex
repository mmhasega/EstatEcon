...
Este tópico está baseado nos materiais de \citet{Sartoris2013} e \citet{Morettin2013}.
...
\hypertarget{usando-o-r-para-construir-o-histograma-do-exemplo-numuxe9rico}{%
\subsection{Usando o R para construir o histograma do exemplo numérico}\label{usando-o-r-para-construir-o-histograma-do-exemplo-numuxe9rico}}
...
\hypertarget{usando-a-funuxe7uxe3o-hist-do-r-para-elaborar-o-histograma-de-altura}{%
\subsection{Usando a função hist do R para elaborar o histograma de altura}\label{usando-a-funuxe7uxe3o-hist-do-r-para-elaborar-o-histograma-de-altura}}
...
\hypertarget{obtendo-o-histograma}{%
\subsection{Obtendo o histograma}\label{obtendo-o-histograma}}
...
\hypertarget{obtendo-o-histograma-usando-uma-forma-alternativa}{%
\section{Obtendo o histograma usando uma forma alternativa}\label{obtendo-o-histograma-usando-uma-forma-alternativa}}
...
\section{Diagrama de caixa (Boxplot)}\label{diagrama-de-caixa-boxplot}}
...
\chapter{Medidas de relação linear entre duas variáveis}\label{medidas-de-relauxe7uxe3o-linear-entre-duas-variuxe1veis}}
