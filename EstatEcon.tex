...
\{\centering \textbackslash includegraphics{[}width=0,8\linewidth{]}\{EstatEcon\_files/figure-latex/nice-fig-1\}
...
\hypertarget{revisao-de-literatura}{%
\chapter{Revisao de Literatura}\label{revisao-de-literatura}}
...
\chapter{Aplicacoes}\label{aplicacoes}}
...
\chapter{Consideracoes Finais}\label{consideracoes-finais}}
